...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native MeSure initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this mesure : https://thecodingmachine.github.io/react-native-mesure/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-mesure/issues'
			);
			console.log(
				'- ⭐ If you love this mesure, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-mesure'
			);
