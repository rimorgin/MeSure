import { StyleSheet, Platform, SafeAreaView, StatusBar, View, Dimensions, TouchableOpacity, Image, FlatList, Animated } from 'react-native';
...
export default function Cart() {
  ...
  const handleProceedToCheckOut = () => {
    if (selectedItems.length !== 0) {
      ...
      router.navigate('/checkout'); // Navigate to checkout
    }
  };
