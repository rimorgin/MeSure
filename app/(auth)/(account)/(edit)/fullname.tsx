...
export default function ChangePassword() {
  ...
  const { userId, userFullName, setUserFullName } = useUserStore();
  const currentFullName = userFullName || ''; 
  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <ThemedView style={styles.content}>
        ...
        >please provide your correct full name</ThemedText>
        <ThemedTouchableFilled
          onPress={handleSubmit}
          style={{
            marginTop: 50,
            backgroundColor: fullName !== currentFullName ? mustard : '#AAA' 
          }}
          disabled={!(fullName !== currentFullName)}
        >
